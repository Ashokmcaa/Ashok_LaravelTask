...
@section('content')
<div class="container">
   <button type="button" id="clearFormButton" class="btn btn-primary mb-5" data-toggle="modal" data-target="#exampleModal">
   Add Product
   </button>
...
<script src="{{url('/link/jquery-3.7.0.js')}}"></script>
<script src="{{url('/link/jquery.dataTables.min.js')}}"></script>
<script>
                    ...
                    //    { data: 'product_images' },
                       ...
                       @if(Auth::user()->roleedit==1 || Auth::user()->roledelete==1)
                       {
                           ...
                           render: function (data, type, full, meta) {
                               return '<button class="btn btn-success edit-button drop-shadow btn-sm border-radius-50 btn-sm mr-2 datatableUpdate" @if(Auth::user()->roleedit==0) style="display:none;" @endif data-updateId="' + data.id + '" data-toggle="tooltip" data-placement="top" title="Edit">Edit</button>  <button class="btn btn-danger delete-button drop-shadow border-radius-50 btn-sm datatableDelete" @if(Auth::user()->roledelete==0) style="display:none;" @endif data-deleteId="' + data.id + '" data-toggle="tooltip" data-placement="top" title="Delete">Delete</button>';
                           }
                       }
                       @endif
                   ]
